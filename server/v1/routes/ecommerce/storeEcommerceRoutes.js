...
import storeEcommerceController from "../../controllers/ecommerce/storeControllerEcommerce";
import uploads from "../../../services/FileUploadService";
let storeRepo = new storeEcommerceController();
...
storeRoutes.route("/getBrandCouponList").get((req, res) => {
  storeRepo.getBrandCouponList(req.headers.language)
    .then((result) => {
      return res.success(result.message, result.data);
    })
    .catch((err) => {
