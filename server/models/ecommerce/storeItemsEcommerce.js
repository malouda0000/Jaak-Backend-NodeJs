...
let itemSchema = new Schema( // for manage catalogue from admin website
  {
    ...
    notAvailable: [{ type: Schema.Types.ObjectId, ref: "storeOutletsEcommerce" }],
    notInOutlet: [{ type: Schema.Types.ObjectId, ref: "storeOutletsEcommerce" }],
...
let storeItemsEcommerce = mongoose.model("storeItemsEcommerce", itemSchema);

export default storeItemsEcommerce;
